  ...
  async handleSubmission(e) {
    ...
    const getFieldValue = (newName, oldName) => {
      ...
      if (oldValue && !newValue) {
        console.warn(`⚠️ MIGRATION WARNING: Using deprecated field name '${oldName}'. Update to '${newName}'.`);
        return oldValue;
      }
    ...
    const categorySelect = document.getElementById("categories") || document.getElementById("category");
